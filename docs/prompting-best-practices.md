...
- [Prompting Claude Opus 4.7](#prompting-claude-opus-47) — L70–L226
  - [Response length and verbosity](#response-length-and-verbosity) — L78–L89
  - [Calibrating effort and thinking depth](#calibrating-effort-and-thinking-depth) — L90–L121
  - [Tool use triggering](#tool-use-triggering) — L122–L125
  - [User-facing progress updates](#user-facing-progress-updates) — L126–L129
  - [More literal instruction following](#more-literal-instruction-following) — L130–L133
  - [Tone and writing style](#tone-and-writing-style) — L134–L143
  - [Controlling subagent spawning](#controlling-subagent-spawning) — L144–L153
  - [Design and frontend defaults](#design-and-frontend-defaults) — L154–L198
  - [Interactive coding products](#interactive-coding-products) — L199–L204
  - [Code review harnesses](#code-review-harnesses) — L205–L220
  - [Computer use](#computer-use) — L221–L226
- [General principles](#general-principles) — L227–L392
  - [Be clear and direct](#be-clear-and-direct) — L229–L253
  - [Add context to improve performance](#add-context-to-improve-performance) — L254–L273
  - [Use examples effectively](#use-examples-effectively) — L274–L284
  - [Structure prompts with XML tags](#structure-prompts-with-xml-tags) — L285–L292
  - [Give Claude a role](#give-claude-a-role) — L293–L312
  - [Long context prompting](#long-context-prompting) — L313–L378
  - [Model self-knowledge](#model-self-knowledge) — L379–L392
- [Output and formatting](#output-and-formatting) — L393–L505
  - [Communication style and verbosity](#communication-style-and-verbosity) — L395–L408
  - [Control the format of responses](#control-the-format-of-responses) — L409–L441
  - [LaTeX output](#latex-output) — L442–L449
  - [Document creation](#document-creation) — L450–L459
  - [Migrating away from prefilled responses](#migrating-away-from-prefilled-responses) — L460–L505
- [Tool use](#tool-use) — L506–L570
  - [Tool usage](#tool-usage) — L508–L550
  - [Optimize parallel tool calling](#optimize-parallel-tool-calling) — L551–L570
- [Thinking and reasoning](#thinking-and-reasoning) — L571–L646
  - [Overthinking and excessive thoroughness](#overthinking-and-excessive-thoroughness) — L573–L588
  - [Leverage thinking & interleaved thinking capabilities](#leverage-thinking--interleaved-thinking-capabilities) — L589–L646
- [Agentic systems](#agentic-systems) — L647–L827
  - [Long-horizon reasoning and state tracking](#long-horizon-reasoning-and-state-tracking) — L649–L724
    - [Context awareness and multi-window workflows](#context-awareness-and-multi-window-workflows) — L653–L666
    - [Multi-context window workflows](#multi-context-window-workflows) — L667–L689
    - [State management best practices](#state-management-best-practices) — L690–L724
  - [Balancing autonomy and safety](#balancing-autonomy-and-safety) — L725–L739
  - [Research and information gathering](#research-and-information-gathering) — L740–L755
  - [Subagent orchestration](#subagent-orchestration) — L756–L771
  - [Chain complex prompts](#chain-complex-prompts) — L772–L777
  - [Reduce file creation in agentic coding](#reduce-file-creation-in-agentic-coding) — L778–L787
  - [Overeagerness](#overeagerness) — L788–L805
  - [Avoid focusing on passing tests and hard-coding](#avoid-focusing-on-passing-tests-and-hard-coding) — L806–L817
  - [Minimizing hallucinations in agentic coding](#minimizing-hallucinations-in-agentic-coding) — L818–L827
- [Capability-specific tips](#capability-specific-tips) — L828–L867
  - [Improved vision capabilities](#improved-vision-capabilities) — L830–L835
  - [Frontend design](#frontend-design) — L836–L867
- [Migration considerations](#migration-considerations) — L868–L960
  - [Migrating from Claude Sonnet 4.5 to Claude Sonnet 4.6](#migrating-from-claude-sonnet-45-to-claude-sonnet-46) — L886–L960
    - [If you're not using extended thinking](#if-youre-not-using-extended-thinking) — L897–L910
    - [If you're using extended thinking](#if-youre-using-extended-thinking) — L911–L960
      - [Migrating to adaptive thinking](#migrating-to-adaptive-thinking) — L915–L934
      - [Keeping budget_tokens during migration](#keeping-budget_tokens-during-migration) — L935–L960
