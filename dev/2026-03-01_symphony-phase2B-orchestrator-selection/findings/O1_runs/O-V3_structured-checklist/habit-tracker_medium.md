...
- Swap rationale: Habit-tracker is a single-product consumer UX design with one user audience and one product surface. There are no distinct systems that constrain each other and require reconciliation — the checklist explicitly lists "Single-product UX design (habit-tracker)" as a keep-Analogist case.
...
- Trigger strength: none
- Topic citation: "leaning toward modern JS framework + cloud backend"
- Decision: exclude
