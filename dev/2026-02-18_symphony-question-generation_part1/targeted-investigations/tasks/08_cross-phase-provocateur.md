...
### I08: Cross-Phase Convergence — The Provocateur

**Key question:** Does the Provocateur ask questions that open territory beyond its own brainstorming strengths? The Provocateur is hypothesized to show **low convergence** — its absurdist, impossible-premise questions should open territory that no single persona "owns," creating diverse brainstorming space for the entire Phase 3 roster rather than pre-loading Provocateur-specific territory.

**Research question addressed:** RQ4 (cross-phase convergence)

**Hypothesis:** Low convergence. The Provocateur's questions should be "selfless" — absurdist provocations that multiple personas can respond to from different angles. The Provocateur's brainstorming responses tend to be pattern-breaking and unexpected; its questions should open territory for Pragmatists, Technical Experts, Empaths, and others to explore from their own perspectives.

**Quantitative context:**
- Phase 2B questions: 8.5 KB avg across 3 topics (CV=16.3%). Highest on tool-library (10.1 KB). Habit-tracker has structural anomaly (2 empty clusters).
- Phase 3 responses: ~82 KB total across 3 topics × 4 clusters (~6.9 KB avg per response file)
- Provocateur is classified as Generative in Phase 3, rated "Very high" fitness for question generation in external research

**Files to read (15 files, ~108 KB total):**

Phase 2B questions (3 files, ~25 KB):
...
Phase 3 brainstorming responses (12 files, ~82 KB):
- `test-runs/symphony-phase3-brainstorming-persona-eval/space-party_2026-02-15/responses/01_theme-and-experience/the-provocateur.md` (7.3 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/space-party_2026-02-15/responses/02_activities-and-engagement/the-provocateur.md` (6.2 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/space-party_2026-02-15/responses/03_logistics-and-safety/the-provocateur.md` (6.1 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/space-party_2026-02-15/responses/04_inclusion-and-community/the-provocateur.md` (6.0 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/tool-library_2026-02-15/responses/01_mission-and-model/the-provocateur.md` (8.0 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/tool-library_2026-02-15/responses/02_operations-and-systems/the-provocateur.md` (8.8 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/tool-library_2026-02-15/responses/03_equity-and-access/the-provocateur.md` (9.1 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/tool-library_2026-02-15/responses/04_sustainability-and-growth/the-provocateur.md` (4.3 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/habit-tracker_2026-02-15/responses/01_product-vision-and-differentiation/the-provocateur.md` (7.1 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/habit-tracker_2026-02-15/responses/02_user-experience-and-engagement/the-provocateur.md` (6.2 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/habit-tracker_2026-02-15/responses/03_technical-architecture/the-provocateur.md` (6.1 KB)
- `test-runs/symphony-phase3-brainstorming-persona-eval/habit-tracker_2026-02-15/responses/04_business-and-sustainability/the-provocateur.md` (4.6 KB)
...
6. Identify specific examples of "selfless" questions — provocative questions that other personas (Pragmatist, Empath, Technical Expert, etc.) could respond to more substantively than the Provocateur itself
7. Note the habit-tracker structural anomaly: does the 2-empty-clusters issue affect the convergence analysis?

**Expected output:** Per-topic convergence rating, overall convergence rating, specific thematic overlap evidence, "selfless question" examples, comparison to Visionary convergence pattern (if I07 has run), implications for Phase 2B.

**Priority:** Medium — the Provocateur is the strongest test case for the low-convergence hypothesis and the top external-research candidate for Phase 2B inclusion.

**Output file:** `docs/dev/2026-02-18_question-generation-eval/targeted-investigations/08_cross-phase-provocateur.md`
