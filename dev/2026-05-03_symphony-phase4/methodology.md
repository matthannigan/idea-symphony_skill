...
**Companion reads:**
- The four `test-runs/{topic}/effort-comparison.md` documents (career-change, food-truck, habit-tracker, space-party)
...
The Phase 2B and Phase 2C investigations validated question-generation and synthesis through structured tracks (PR1/PI1/O1/GT1 and BL1/SP1/PC1/TDA1). Phase 4 has accumulated three prompts (`phase4_full-synthesis.md`, `phase4_summary-only_low-effort.md`, `phase4_summary-only_min-effort.md`) and a model-audit trail without a comparable investigation series. The four cross-effort comparisons read PLAN/QUESTIONS/BRAINSTORM only and infer Phase 4 quality through Phase 5 output, leaving the Phase 4 → Phase 5 fidelity hop unobserved.
...
- Any change to Phase 3 (persona response generation) — settled by Phase 2C and the four effort-comparison memos. Phase 3 outputs are treated as fixed.
